...
export default function Main() {
  ...
  return (
    <main className="mx-auto max-w-[1100px] w-full ">
      <div className="flex justify-center mx-auto w-full pt-6 gap-[24px]">
        <div className="grow max-w-[580px] flex-col gap-4">
        ...
        <div className="grow max-w-[495px]">
          <div className="border rounded-lg">
            <div className="flex justify-between item-center border-b p-4">
